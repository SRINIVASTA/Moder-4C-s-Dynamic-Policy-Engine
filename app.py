...
def load_data(uploaded_file):
    ...
    # Clean column names (handles trailing spaces in CSVs)
    df.columns = df.columns.str.strip()
    
    # FICO Proxy Logic (Since FICO isn't in your raw data image)
...
# ==========================================
# 3. POLICY SLIDERS (The Control Group)
# ==========================================
st.sidebar.header("⚙️ Underwriting Policy")
# Initialized at Standard Agency Guidelines
